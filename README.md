...
Compared to AWS Config notification, this won't fill your email inbox with notifications and you can use a different SNS topic than you use for AWS config. Email will be more readable compared to Config.
